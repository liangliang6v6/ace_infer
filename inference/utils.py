...
# def init_llm(model_path, tokenizer=None, tensor_parallel_size=1, gpu_memory_utilization=0.88):
...
#     """
#     Calls the LLM using vllm's generate function.
#     Injects a strict system prompt to prevent conversational greetings.
#     """
#     # Force Qwen into task-execution mode, not conversation mode
#     messages = [
#         {"role": "system", "content": "You are a strict QA bot. You must answer the user's question directly based on the context provided. Do not include any conversational filler, greetings, or confirmations. Output ONLY the answer."},
#         {"role": "user", "content": prompt.strip()}
#     ]
    
#     # Apply ChatML template natively
#     text = tokenizer.apply_chat_template(
#         messages,
#         tokenize=False,
#         add_generation_prompt=True
